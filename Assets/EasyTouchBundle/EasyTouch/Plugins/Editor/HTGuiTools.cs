...
public class HTGuiTools
{
	...
	{
		if (leftToggle) value = EditorGUILayout.ToggleLeft (text, value);
	...
	public static bool Toggle (string text, bool value, int width, bool leftToggle = false)
	{
		...
		if (leftToggle) value = EditorGUILayout.ToggleLeft (text, value, GUILayout.Width (width));
		else value = EditorGUILayout.Toggle (text, value, GUILayout.Width (width));
