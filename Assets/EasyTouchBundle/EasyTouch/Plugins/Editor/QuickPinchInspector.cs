	...
	public override void OnInspectorGUI ()
	{
		...
		if (t.actionTriggering == QuickPinch.ActionTiggering.InProgress)
		{
			...
			if (t.enableSimpleAction)
			{
				...
				t.directAction = (QuickBase.DirectAction)EditorGUILayout.EnumPopup ("Action", t.directAction);
				t.axesAction = (QuickBase.AffectedAxesAction)EditorGUILayout.EnumPopup ("Affected axes", t.axesAction);
